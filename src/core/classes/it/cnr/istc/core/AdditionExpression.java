...
public class AdditionExpression implements Expression {
    ...
    public AdditionExpression(final Expression... xprs) {
        this(Arrays.asList(xprs));
    }

    public AdditionExpression(final List<Expression> xprs) {
        this.xprs = xprs;
    }
    ...
    public Item evaluate(IScope scp, IEnv env) throws CoreException {
        ...
        return scp.getCore().add(itms.toArray(new Item.ArithItem[itms.size()]));
    }
